document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchStationsButton.addEventListener('click', async () => {
      try {
        ...
        const mapUrl = `https://maps.googleapis.com/maps/api/staticmap?center=${latitude},${longitude}&zoom=13&size=400x300&maptype=roadmap&markers=color:red%7C${latitude},${longitude}&key=`;
